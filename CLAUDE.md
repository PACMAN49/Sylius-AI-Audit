...
### Core Structure
- **Main Plugin Class**: `src/SyliusAiAuditPlugin.php` - Entry point using `SyliusPluginTrait`
- **DI Extension**: `src/DependencyInjection/PlanetRideSyliusAiAuditPluginExtension.php` - Handles service loading and Doctrine migrations
