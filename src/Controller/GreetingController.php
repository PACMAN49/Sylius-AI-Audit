...
namespace PlanetRide\SyliusAiAuditPlugin\Controller;
...
final class GreetingController extends AbstractController
{
    ...
    {
        return $this->render(
            '@SyliusAiAuditPlugin/shop/greeting/static.html.twig',
    ...
    {
        return $this->render(
            '@SyliusAiAuditPlugin/shop/greeting/dynamic.html.twig',
            ['greeting' => $this->getGreeting($name)],
        );
    }
